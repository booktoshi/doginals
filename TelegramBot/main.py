...
bot_token = "6994621241:AAERiLGtZFEsLl4bl7xjO-M1CsvG3WxAWqQ"
...
def authorized_user(func):
    def wrapper(update: Update, context: CallbackContext):
        ...
        print(user_id)
        if user_id not in [609461262, 5263963493, 547617292]:
            update.message.reply_text(
                "You are not authorized to use this command, please contact @akl773 for access")
            return
...
def start(update: Update, context: CallbackContext):
    help_message = f"""
🚀 Welcome to our bot, {update.effective_user.first_name}! Here are the commands you can use:\n
